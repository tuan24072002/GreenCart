...
const Login = () => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        e.preventDefault();
        setUser({
            email: "contact@tranleanhtuan.site",
    ...
    return (
        <div className="fixed top-0 left-0 right-0 bottom-0 z-30 flex items-center text-sm text-gray-600 bg-black/50">
            <form onSubmit={handleSubmit} ref={ref} className="flex flex-col gap-4 m-auto items-start p-8 py-12 w-80 sm:w-[352px] rounded-lg shadow-xl border border-gray-200 bg-white">
