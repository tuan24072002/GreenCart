    ...
    return (
        <div className="flex-1 flex flex-col justify-between">
            <div className="w-full md:p-10 p-4">
                ...
                <div className="flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md border border-gray-500/20 h-[calc(100vh-155px)] overflow-y-auto no-scrollbar">
